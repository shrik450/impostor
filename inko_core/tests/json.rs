...
fn parse_json(content: String) -> Result<JsonValue, inko_core::parser::Error> {
    let mut reader = inko_core::parser::Reader::new(content.as_str());
    inko_core::parser::parse_json(&mut reader)
}
