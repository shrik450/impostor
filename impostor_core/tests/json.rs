...
use impostor_core::ast::JsonValue;
...
fn parse_json(content: String) -> Result<JsonValue, impostor_core::parser::Error> {
    let mut reader = impostor_core::parser::Reader::new(content.as_str());
    impostor_core::parser::parse_json(&mut reader)
}
